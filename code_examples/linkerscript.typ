```l
MEMORY {
  icache (rwx)  : ORIGIN = 0x4037c000, LENGTH = 16k
...
/* The ESP32-C3 ROM exposes a second printf entry at 0x400004a4. We deliberately
   hide it (prefix with XXX) so that the simpler ROM printf at 0x40000040 above
   stays the single authoritative resolution for the `printf` symbol.          */
